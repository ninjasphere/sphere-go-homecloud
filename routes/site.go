...
func (lr *SiteRouter) GetAll(r *http.Request, w http.ResponseWriter, siteModel *homecloud.SiteModel, stateManager state.StateManager) {
...
func (lr *SiteRouter) GetSite(params martini.Params, w http.ResponseWriter, siteModel *homecloud.SiteModel, stateManager state.StateManager) {
...
func (lr *SiteRouter) PutSite(params martini.Params, r *http.Request, w http.ResponseWriter, siteModel *homecloud.SiteModel) {
...
func (lr *SiteRouter) DeleteSite(params martini.Params, w http.ResponseWriter, siteModel *homecloud.SiteModel) {
